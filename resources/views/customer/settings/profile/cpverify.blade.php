    ...
    <div class="row px-2 pt-5">
        <div class="col-lg-8 col-xl-6 card flex-column mx-auto mt-5 shadow p-3border-3">
            <div class="card-body mx-auto ">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.profile.pgetcode') }}">
                        @csrf
                        @method('PUT')
                       ...
                       <div>
                            ...
                            <div class="form-input" >
                                <input class="@error('cp_number') is-invalid @enderror form-input"  type="" id="cp_number" name="cp_number" placeholder="example: 639165149430" pattern="[6]{1}[3]{1}[0-9]{10}" required autofocus> 
