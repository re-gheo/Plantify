                ...
                <div class="card-body">
                        ...
                        <div class="form-input">
                            ...
                            <div>
                                <input id="retailer_address" type="text"
                                    class=" @error('retailer_address') is-invalid @enderror" name="retailer_address"
                                    required autocomplete="retailer_address">
                    ...
                    <div>
                        ...
                        <div class="form-input">
                            ...
                            <div>
                                <input id="retailer_barangay" type="text"
                                    class=" @error('retailer_barangay') is-invalid @enderror" name="retailer_barangay"
                                    required autocomplete="retailer_barangay">
                        ...
                        <div class="form-input">
                            ...
                            <div>
                                <input id="retailer_region" type="text"
                                    class=" @error('retailer_region') is-invalid @enderror" name="retailer_region" required
                                    readonly value="NCR" autocomplete="retailer_region">
