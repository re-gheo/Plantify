    ...
    <div class="card-body">
        ...
        <form action="/settings/application/form" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div>
                    <input id="retailer_address" type="text" class=" @error('retailer_address') is-invalid @enderror"
                        name="retailer_address" required autocomplete="retailer_address">
            ...
            <div>
                ...
                <div>
                    <input id="retailer_postalcode" type="text" class=" @error('retailer_postalcode') is-invalid @enderror"
                        name="retailer_postalcode" placeholder="0000" pattern="[0-9]{4}" autocomplete="retailer_postalcode">
            ...
            <div>
                ...
                <div>
                    <input id="retailer_personincharge" type="text"
                        class=" @error('retailer_personincharge') is-invalid @enderror" name="retailer_personincharge"
                        required readonly value="{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}"
            ...
            <div>
                ...
                <div>
                    <input id="retailer_idnumber" type="text" class=" @error('retailer_idnumber') is-invalid @enderror"
                        name="retailer_idnumber" pattern="[0-9]{6}" required autocomplete="retailer_idnumber">
        ...
        <div>
            ...
            <div>
                ...
                <div>
                    <input id="retailer_barangay" type="text" class=" @error('retailer_barangay') is-invalid @enderror"
                        name="retailer_barangay" required autocomplete="retailer_barangay">
