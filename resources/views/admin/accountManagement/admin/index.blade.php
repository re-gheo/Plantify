...
@section('content')
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row justify-items-center">
                                        @if (Auth::id() != $user->id)
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button form="banForm" type="submit"
                                                                        class="btn btn-primary">Confirm Block</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            @else
                                                <form action="{{ route('admin.user.unban', ['id' => $user->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    <button class="btn btn-success " type="submit">Unblock | Set To
                                                        Active</button>
                                                </form>
                                            ...
                                            <form id="deleteForm"
                                                action="{{ route('admin.user.admin.delete', ['id' => $user->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
                                        ...
                                        <a class="btn btn-success text"
                                            href="{{ route('admin.user.admin.edit', ['id' => $user->id]) }}">Edit</a>
                                    </div>
    ...
    <div class="modal fade" id="createAdminModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="createAdmin" action="{{ route('admin.user.admin.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fn" name="fn" aria-describedby="fn"
                                placeholder="Enter First Name" required>
                        </div>

                        <div class="form-group">
                            <label for="ln">Last Name</label>
                            <input type="text" class="form-control" id="ln" name="ln" aria-describedby="ln"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" placeholder="plantifyadminpassword"
                                disabled>
                        </div>
                    </form>
                </div>
