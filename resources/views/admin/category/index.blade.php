                ...
                <div class="container">
                    ...
                    <table class="table table-bordered table-striped table-hover   card-body table-responsive-sm">
                        ...
                        @forelse ($categories as $category)
                            ...
                            <tr>
                                <form action="{{ route('categories.update', $category->product_categoryid) }}"
                                    method="POST">
                                    @csrf
                                    @method('put')
                                ...
                                <form id="deleteForm"
                                    action="{{ route('categories.destroy', $category->product_categoryid) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                ...
                                {{-- Old Delete Code --}}
                                {{-- <form action="{{ route('categories.destroy', ['id' => $category->product_categoryid]) }}"
                                    method="POST"> @csrf
                                    @method('DELETE')
