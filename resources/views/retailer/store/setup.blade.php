        ...
        <div class="col-lg-8 col-xl-6 card flex-column mx-auto mt-5 shadow p-3border-3 ">
            <div class="card-body mx-auto  ">
                ...
                <form method="POST" action="/settings/store/setup">
                   ...
                   <div>                     
                        <label for="store_name" ><h5><b>Make a Name for your store</b> </h3> </label>
                        <p><b>Note:</b> your store name cant be changed</p>

                        <div class="form-input" >
                            <input id="store_name" type="text" class=" @error('store_name') is-invalid @enderror" name="store_name" value="{{ old('store_name') }}" required autocomplete="store_name" autofocus>
