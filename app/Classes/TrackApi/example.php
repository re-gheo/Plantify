...
//$data = ["num" => "UB209300714LV", "express" => "cainiao"];
//$response = $api->realtime($data);

# archive
$data = ["tracking_number" => "RP325552475CN", "express" => "china-post"];
...
// $data = ["num" => "RP325552475CN", "express" => "china-post"];
// $response = $api->create($data);

# Create multiple tracking numbers
// $data = [
// 	["num" => "RP325552475CN", "carrier_code" => "china-post"],
// 	["num" => "LZ448865302CN", "carrier_code" => "china-ems"],
// ];
// $response =$api->create($data);
...
// $data = ["num" => "RP325552475CN,LZ448865302CN"];
// $response = $api->get($data);

# Modify other information of a tracking number
//$data = ['num'=>"RP325552475CN",'express'=>"china-post","order_id" => "#1234"];
// $response = $api->modifyinfo($data);

# Modify the information of multiple tracking numbers
// $data = [
// 	["num" => "RP325552475CN", "carrier_code" => "china-post", "order_id" => "#1234",],
// 	["num" => "LZ448865302CN", "carrier_code" => "china-ems", "order_id" => "#5678",],
// ];
// $response =  $api->modifyinfo($data);
